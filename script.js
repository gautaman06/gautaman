  ...
  const buildMenu = () => {
    if (winner === human) {
      return (
        ...
        React.createElement("p", { className: "menu-text" }, "Beat the Computer Again?"),
      ...
      return (
        ...
        React.createElement("hr", null),
        React.createElement("div", null,
        React.createElement("p", { className: "menu-text" }, "Try Again"),
        React.createElement("button", { onClick: token => startGame('X') }, "X"),
        React.createElement("button", { onClick: token => startGame('O') }, "O"))));
      ...
      return (
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' },
        React.createElement("h1", { className: "title" }, "Game Tied!"),
        React.createElement("hr", null),
        React.createElement("div", null,
        React.createElement("p", { className: "menu-text" }, "Challenge Again ! !"),
        React.createElement("button", { onClick: token => startGame('X') }, "X"),
        React.createElement("button", { onClick: token => startGame('O') }, "O"))));
      ...
      return (
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' },
        React.createElement("h1", { className: "title" }, "Start Game.."),
        React.createElement("hr", null),
        React.createElement("div", null,
        React.createElement("button", { onClick: token => startGame('X') }, "X"),
        React.createElement("button", { onClick: token => startGame('O') }, "O"))));
